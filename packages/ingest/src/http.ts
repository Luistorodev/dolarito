 ...
 * | `buda`, `binance_p2p`, `eldorado` | Order books and P2P listings. They change continuously rather than on a published cycle, so what constrains us is the documented rate limit, not a refresh interval. **Rate limits unread.** Each adapter task (T014, T015, T016) must record the real figure here. |
