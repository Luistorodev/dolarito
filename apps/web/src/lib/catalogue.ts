...
export const PROVIDERS: DisplayProvider[] = [
  { id: 'eldorado', name: 'El Dorado', mode: 'local' },
  { id: 'dolarapp', name: 'DolarApp', mode: 'local' },
  { id: 'binance_p2p', name: 'Binance P2P', mode: 'local' },
  { id: 'bitso', name: 'Bitso', mode: 'local' },
  { id: 'buda', name: 'Buda', mode: 'local' },
  { id: 'wise', name: 'Wise', mode: 'remesa' },
  { id: 'instarem', name: 'Instarem', mode: 'remesa' },
  { id: 'western_union', name: 'Western Union', mode: 'remesa' },
];
